...
```{r}
knitr::include_graphics(here::here("content/assets/img/token.svg"))
```
...
```{r}
knitr::include_graphics(here::here("content/assets/img/stemm_lemm.svg"))
```
...
```{r}
knitr::include_graphics(here::here("content/assets/img/embeddings.svg"))
```
