...
Bevor der Text für weitere Analysen genutzt werden kann, muss er, wie unter {{{< crossref path="/methods/preprocessing" label="Vorverarbeitung" >}}} beschrieben, in ein geeignetes Format überführt werden.
